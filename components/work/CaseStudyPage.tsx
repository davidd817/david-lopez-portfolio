...
export function CaseStudyPage({ project }: { project: WorkProject }) {
  return <main id="main-content" className="min-h-screen bg-slate-950 text-white">
    <RouteScrollTop />
    <CaseStudyHero category={project.category} tier={project.tier} title={project.title} subheadline={project.subheadline} opening={project.opening} hero={project.heroFullWidth ? undefined : project.hero} actions={project.heroLinks} />
    <ProjectSnapshot items={project.snapshot} />
    {project.heroFullWidth && project.hero ? <div className="mx-auto max-w-7xl px-5 pb-12 md:px-8 md:pb-16"><FigureBlock asset={project.hero} eager /></div> : null}
